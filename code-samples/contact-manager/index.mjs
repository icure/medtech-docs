//tech-doc: Prepare for contact creation
import {
    Api,
    CodeStub,
    Contact,
...
const { contactApi, patientApi, userApi, healthcarePartyApi, cryptoApi } = Api(host, 'esmith', 'mypassword', crypto)
...
console.log(JSON.stringify(fetchedContact, null, ' '))
