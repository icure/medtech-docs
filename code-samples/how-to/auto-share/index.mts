...
//tech-doc: end
expect((await hcp1Api.dataSampleApi.getDataSample(dataSampleNotOnModify.id)).content["en"].stringValue).to.equal(contentNotOnModify)
...
//tech-doc: end
expect((await hcp1Api.dataSampleApi.getDataSample(dataSampleNotSharedAnymore.id)).content["en"].stringValue).to.equal(contentNotSharedAnymore)
...
//tech-doc: end
expect((await hcp1Api.dataSampleApi.getDataSample(dataSampleNoChaining.id)).content["en"].stringValue).to.equal(contentNoChaining)
