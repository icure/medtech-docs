...
expect((await hcp1Api.healthcareElementApi.getHealthcareElement(healthcareElement.id)).description).to.equal(description) //skip
expect((await hcp2Api.healthcareElementApi.getHealthcareElement(healthcareElement.id)).description).to.be.undefined //skip
...
expect((await hcp2Api.healthcareElementApi.getHealthcareElement(healthcareElement.id)).description).to.equal(description)
...
expect((await pApi.dataSampleApi.getDataSample(dataSample.id)).content["en"].stringValue).to.equal(contentString) //skip
...
expect((await hcp2Api.dataSampleApi.getDataSample(dataSample.id)).content["en"].stringValue).to.equal(contentString)
expect((await pApi.dataSampleApi.getDataSample(dataSample.id)).content["en"].stringValue).to.equal(contentString)
