...
const additionalEnvs = {
  ...
  ICURE_USER3_NAME: env.dataOwnerDetails[hcp1Username].user,
  ICURE_USER3_PASSWORD: env.dataOwnerDetails[hcp1Username].password,
  ICURE_USER3_PRIV_KEY: env.dataOwnerDetails[hcp1Username].privateKey,
