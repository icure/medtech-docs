...
A Code is a non-encryptable entity that represents a concept from a medical codification system (e.g., 
...
Below you will find an explanation of the most commonly used properties in the entity. For a full list, check the 
[references](TODO).
