...
The Contact is an encryptable entity that records the medical information about the patient. A visit to the patient's house, a
...
- `descr`
- The `markdown` field in all the `note`s.
...
### closingDate
The `closingDate` represent the starting moment of the event of the Contact. It is a timestamp, precise to the second,
