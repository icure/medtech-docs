...
before being sent on the cloud. You can read more about store big files in Cardinal [here](/nsdk/how-to/store-big-files).

## Fields Encrypted by Default
In this entity, no field is encrypted by default. You can customize the encrypted fields as [explained in this how to](/nsdk/how-to/initialize-the-sdk/configure-what-to-encrypt).
...
store big files in Cardinal, check this [how to](/nsdk/how-to/store-big-files).
...
[how to](/nsdk/how-to/store-big-files).

### openingContactId
The id of the [Contact](/nsdk/explanations/data-model/contact) that represent the encounter where this document was 
created.
...
about storing and retrieving secondary attachments, check this [how to](/nsdk/how-to/store-big-files).
