...
Any HealthcareParty associated to a [User](/nsdk/explanations/data-model/user) is able to log in, initialize their own 
...
### specialityCodes
A collection of [CodeStub](/nsdk/explanations/data-model/codestub)s to store the medical specialties of this 
...
options in the [SDK configuration](/nsdk/how-to/initialize-the-sdk/#cryptography-configurations).