...
Identifier's `system` and `value` can be used to [search data using filters](/nsdk/how-to/querying-data).
...
### type
A [CodeStub](/nsdk/explanations/data-model/codestub) that defines the type of this identifier with respect to a
codification system.
