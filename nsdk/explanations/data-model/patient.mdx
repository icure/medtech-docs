...
### dateOfBirth
The date of birth of the Patient as a [FuzzyDate](/nsdk/explanations/data-model/#fuzzydate).

### dateOfDeath
The date of death of the Patient as a [FuzzyDate](/nsdk/explanations/data-model/#fuzzydate).

### deactivationDate
If the `active` field is false, this should contain the date of the deactivation of the patient.
It is encoded as a [FuzzyDate](/nsdk/explanations/data-model/#fuzzydate).
