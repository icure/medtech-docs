...
A SubContact is an encryptable nested entity that is used to link [Contact](/nsdk/explanations/data-model/contact)s and
[Service](/nsdk/explanations/data-model/service)s to other structuring element that can provide an additional medical
context, such as [HealthElement](/nsdk/explanations/data-model/healthelement), healthcare approach (PlanOfAction), or
medical forms.
...
### healthElementId
The id of an [HealthElement](/nsdk/explanations/data-model/healthelement) that was opened in the contact, referenced by
