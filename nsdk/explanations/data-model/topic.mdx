...
A Topic is an encryptable, root-level entity that can be used in combination with the [Message](/nsdk/explanations/data-model/message) 
...
### linkedHealthElements
A collection containing the ids of the [HealthElement](/nsdk/explanations/data-model/healthelement)s that are a subject
of this topic.

### linkedServices
A collection containing the ids of the [Service](/nsdk/explanations/data-model/service)s that are a subject
of this topic.