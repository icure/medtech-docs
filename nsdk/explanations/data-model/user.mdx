...
For more information, check the explanation on [data owners and access control](nsdk/explanations/data-owners-and-access-control).
...
As for the password, it is possible both to set a password (in the `passwordHash` field) or to use a [temporary token](/nsdk/how-to/remember-me). 
...
To learn how to update the roles on a user, check this [how to](/nsdk/how-to/define-user-roles).


## Data Owner Users
A User is a **Data Owner** User if exactly one of the following is true:

- They have the id of a valid [HealthcareParty](/nsdk/explanations/data-model/healthcareparty) in the `healthcarePartyId` field.
- They have the id of a valid [Patient](/nsdk/explanations/data-model/patient) in the `patientId` field.
- They have the id of a valid [Device](/nsdk/explanations/data-model/device) in the `deviceId` field.
...
Then, the user will be able to create, modify and search encrypted data. You can read more about data owner users [here](/nsdk/explanations/data-owners-and-access-control)
...
of the SDK. More information about application tokens can be found in [this how to](/nsdk/how-to/remember-me).

### deviceId
The id of the [Device](/nsdk/explanations/data-model/device) associated to this User. If this field is not null,
...
### healthcarePartyId
The id of the [HealthcareParty](/nsdk/explanations/data-model/healthcareparty) associated to this User. If this field
...
### patientId
The id of the [Patient](/nsdk/explanations/data-model/patient) associated to this User. If this field is not null, 
...
To change the roles of a User, check this [how to](/nsdk/how-to/define-user-roles).
