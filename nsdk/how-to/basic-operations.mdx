...
This is especially the case if you want the other delegates to be able to [listen to the creation event for that entity](/nsdk/how-to/realtime).
...
If you want to learn more about the querying system refer to the [dedicated page](/nsdk/how-to/querying-data).
