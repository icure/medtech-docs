...
Refer to the [encrypted links explanation page](/explanations/encrypted-links) to learn more about how the
...
This is especially the case if you want the other delegates to be able to [listen to the creation event for that entity](/how-to/realtime).
