...
suspend fun getIdsOfPatientsMatching(sdk: IcureSdk, patientFilterOptions: FilterOptions\u003CPatient\u003E): List\u003CString\u003E =
	sdk.patient.matchPatientsBy(patientFilterOptions)`}</Kotlin>
<Typescript>{`import {FilterOptions, IcureSdk, Patient} from "@icure/api";\n
function getIdsOfPatientsMatching(sdk: IcureSdk, patientFilterOptions: FilterOptions\u003CPatient\u003E): Promise\u003CArray\u003Cstring\u003E\u003E {
...
def get_ids_of_patients_matching(sdk: IcureSdk, patient_filter_options: FilterOptions[Patient]) -> List[str]:
...
suspend fun getPatientsIterator(sdk: IcureSdk, patientFilterOptions: FilterOptions\u003CPatient\u003E): PaginatedListIterator\u003CPatient\u003E =
...
// Get the iterator over patients, attempting to decrypt them.
// If one of the retrieved patients can't be decrypted you will get the encrypted patient.
function getPatientsIterator(sdk: IcureSdk, patientFilterOptions: FilterOptions\u003CPatient\u003E): Promise\u003CPaginatedListIterator\u003CPatient\u003E\u003E {
...
# Get the iterator over patients, attempting to decrypt them.
# If one of the retrieved patients can't be decrypted you will get the encrypted patient.
def get_patients_iterator(sdk: IcureSdk, patient_filter_options: FilterOptions[Patient]) -> PaginatedListIterator[Patient]:
...
import com.icure.sdk.model.Patient
import com.icure.sdk.utils.pagination.PaginatedListIterator\n
suspend fun getSortedAcuteOrLongCovidDiagnosesForPatient(sdk: IcureSdk, patient: Patient): PaginatedListIterator\u003CDecryptedHealthElement\u003E {
...
function getSortedAcuteOrLongCovidDiagnosesForPatient(sdk: IcureSdk, patient: Patient): Promise\u003CPaginatedListIterator\u003CDecryptedHealthElement\u003E {
...
<Python>{`from icure.filters import HealthElementFilters, union, intersection, SortableFilterOptions
from icure import IcureSdk
from icure.model import Patient, DecryptedHealthElement, HealthElement
from icure.pagination.PaginatedListIterator import PaginatedListIterator\n
def get_sorted_acute_or_long_covid_diagnoses_for_patient(sdk: IcureSdk, patient: Patient) -> PaginatedListIterator[DecryptedHealthElement]:
	...
	return sdk.health_element.filterHealthElementsBySorted(filter_options)`}</Python>
</SdkCode>
...
import com.icure.sdk.utils.pagination.PaginatedListIterator\n
suspend fun getHeartRateMeasurements(sdk: IcureSdk): PaginatedListIterator\u003CDecryptedService\u003E {
...
async function getHeartRateMeasurements(sdk: IcureSdk): Promise\u003CPaginatedListIterator\u003CDecryptedService\u003E\u003E {
...
<Python>{`from icure.filters import ServiceFilters, PatientFilters, intersection
from icure import IcureSdk
from icure.model import DecryptedService
from icure.pagination.PaginatedListIterator import PaginatedListIterator\n
def get_heart_rate_measurements(sdk: IcureSdk) -> PaginatedListIterator[DecryptedService]:
	...
	return sdk.contact.filter_services_by_blocking(service_filter)`}</Python>
</SdkCode>
