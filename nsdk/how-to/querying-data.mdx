...
healthcare parties](/nsdk/how-to/share-data-with-many-users.mdx)), you should only be using these filter options in your application for the end-users.
...
Unless you're using a special configuration for data owners ([such as hierarchical healthcare parties](/nsdk/how-to/share-data-with-many-users.mdx)), this is
...
We recommend you understand the concepts of [hierarchical healthcare parties](/nsdk/how-to/share-data-with-many-users.mdx)]
and anonymous data owners (:construction:) before you read this section.
...
Note that this requires that the user performing the query has access to all the [secret ids](/nsdk/explanations/encrypted-links) of the patients
