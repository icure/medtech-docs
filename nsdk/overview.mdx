...
healthcare_element = sdk.healthcare_element.create_healthcare_element_blocking(
...
maybe_decrypted_health_element = sdk.healthcare_element.tryAndRecover.get_healthcare_element_blocking(healthcare_element.id)
...
patient_of_health_element = sdk.healthcare_element.decrypt_patient_id_of_blocking(healthcare_element)`}
    </Python>
</SdkCode>
