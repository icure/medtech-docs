...
# Tutorial: Publisher and Subscriber Example
...
3. Familiarized yourself with the Cardinal SDK by following the [introductory tutorial](/nsdk/tutorial/basic/sdk-basic-tutorial).
