...
Then, the Subscriber which types of data it wants to receive and it can do using a [filter](/nsdk/how-to/querying-data).
...
For more information about subscriptions and events, check [this how-to](/nsdk/how-to/how-to-subscribe-to-events).
...
[Different types of events can be produced](/nsdk/how-to/how-to-subscribe-to-events#buffered-events) by the channel. In
