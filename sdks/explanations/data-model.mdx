...
### [Healthcare Element](/{{ sdk }}/explanations/data-model/healthcare-element)
...
It is used by {{ Services }} and {{ HealthcareElements }} to describe the different pieces of medical information.
