...
### [{{Service}}](/{{sdk}}/explanations/data-model/data-sample)
...
### [{{{{HealthcareElementNoSpace}}}}](/{{sdk}}/explanations/data-model/healthcare-element)
...
It is used by {{Services}} and {{{{{{HealthcareElementNoSpace}}sNoSpace}}}} to describe the different pieces of medical information.
