...
A {{Service}} represents a medical information, provided by a Data Owner concerning one specific [Patient], for a T moment.       Provided by a Data Owner means that the {{service}} may have been either provided by a [HealthcareProfessional] or a [Patient], either collected by a [MedicalDevice].         {{Services}} provided by the patient include subjective information, such as complaints, reason for visit, feelings, etc. or objective information       like bio-metric measures (blood pressure, temperature, heart beat, etc.), or physical exam description, diagnosis, prescription, integration of lab reports from another [HealthcareProfessional], action plan, etc.      Any action performed by the [HealthcareProfessional] (which is relevant for a [HealthcareElement] of a [Patient]) is considered as a [DataSample].       The {{services}} can be linked to {{healthcareElements}} or other structuring elements of the medical record
...
The id of the [User] that created this {{service}}. When creating the {{service}}, will be filled automatically by the current user id if not provided.
...
Id of the batch that embeds this {{service}}
...
List of Ids of all canvases linked to the {{Service}}. Only used when the {{Service}} is emitted outside of its batch.
...
A code is an item from a codification system that qualifies the content of this {{service}}. SNOMED-CT, ICPC-2 or ICD-10 codifications systems can be used for codes
...
The timestamp (unix epoch in ms) of creation of this {{service}} in iCure system. Will be filled automatically if not provided.
...
Soft delete (unix epoch in ms) timestamp of the {{service}}
...
List of IDs of all {{healthcareElements}} for which the {{service}} is provided. Only used when the {{Service}} is emitted outside of its batch
...
Typically used for business / client identifiers. An identifier should identify a {{service}} uniquely and unambiguously. However, iCure can't guarantee the uniqueness of those identifiers : This is something you need to take care of.
...
Used for sorting {{services}} inside an upper object (A batch, a transaction, a FHIR bundle, ...)
...
A label is an item from a codification system that qualifies a {{service}} as being member of a certain class, whatever the value it might have taken. If the label qualifies the content of a field, it means that whatever the content of the field, the label will always apply. LOINC is a codification system typically used for labels.
...
The timestamp (unix epoch in ms) of the latest modification of this {{service}} in iCure system. Will be filled automatically if not provided.
...
Links towards related {{services}} (possibly in other batches)
...
The id of the data owner that is responsible of this {{service}}. When creating the {{service}}, will be filled automatically by the current user data owner id ([HealthcareProfessional], [Patient] or [MedicalDevice]) if missing
